...
public class ReceptionistDashboardController implements Initializable {
    ...
    private void loadScheduledLessonsTable() {
        try {
            ...
            e.printStackTrace();
            AlertUtil.showError("Error loading scheduled lessons: " + e.getMessage());
        }
    }
    ...
    public void btnDashboardOnAction(ActionEvent actionEvent) {
        ...
        try {
            AnchorPane anchorPane = FXMLLoader.load(getClass().getResource("/lk.school.elite_driving/view/receptionist/receptionistDashboard.fxml"));
    ...
    public void btnLogOutOnAction(ActionEvent actionEvent) {
        ...
        try {
            anchorPane = FXMLLoader.load(getClass().getResource("/lk.school.elite_driving/view/welcomePage.fxml"));
